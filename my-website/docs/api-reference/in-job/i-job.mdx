...
For a more in-depth understanding of the concept, you can check [the WSPT completion-time doc](/user-guide/single-machine/completion/wspt).

:::

## tilearn.<span className="tilearn-api-name-highlight">show_mytime</span>(*list, due date*)
...
*List layout screenshots (`job-light.png` / `job-dark.png`) can be added under `static/img/` when available.*
...
<table>
  <thead>
    <tr>
      <th style={{ width: "200px", textAlign: "center" }}>Column position</th>
      <th>Meaning</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td style={{ textAlign: "center" }}>The first column</td>
      <td>Indicates the job name.</td>
    </tr>
    <tr>
      <td style={{ textAlign: "center" }}>The second column</td>
