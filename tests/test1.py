...
lists = [
    ...
    pl.List(file_path='/Users/chibangnguyen/Documents/TiLearn/tests/data2.csv', prec=0),
    pl.List(file_path='/Users/chibangnguyen/Documents/TiLearn/tests/data3.csv', prec=0)
]
